...
if HP_WorldLocomotionPrototype == nil and source ~= nil then
    source((g_currentModDirectory or "") .. "scripts/HP_WorldLocomotionPrototype.lua")
end
...
if HP_WorldMovementProbeDelta == nil and source ~= nil then
    source((g_currentModDirectory or "") .. "scripts/HP_WorldMovementProbeDelta.lua")
end
